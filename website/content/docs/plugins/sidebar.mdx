...
The sidebar includes a built-in subscribe feature that lets users add remote ICS calendar feeds. To trigger it, click the options button (`⋯`) in the sidebar header and select **Subscribe to Calendar**, then enter any publicly accessible `.ics` URL.
